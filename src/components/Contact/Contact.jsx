...
const Contact = (props) => {
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">We Help to nourish communities in need – Grab your meal here and join the fight against hunger!</p>
